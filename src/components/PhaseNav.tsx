...
import { ChevronLeft, ChevronRight, Sparkles, Hammer, Zap, Target } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className="absolute -right-3 top-4 z-10 w-6 h-6 p-0 bg-[var(--card)] border border-[var(--border)] rounded-full hover:bg-[var(--brand)]/10"
